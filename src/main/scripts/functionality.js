$(document).ready(function() {
	...
	$("#timesheet").on("click", function() {
		...
		window.location.href =
			"../BizApp-en/src/modules/timesheet/timesheet.html";
	});
	...
	$("#overtime").on("click", function() {
		...
		saveDataToLocalStorage("counter", counter);
		window.location.href =
			"../BizApp-en/src/modules/overtime/overtime.html";
	});
	...
	$("#cafe").on("click", function() {
		...
		saveDataToLocalStorage("infoData", Info);
		saveDataToLocalStorage("counter", counter);
		window.location.href = "../BizApp-en/src/modules/cafe/cafe.html";
	});
	...
	$(document).on("click", "#profit", function() {
		...
		saveDataToLocalStorage("infoData", Info);
		saveDataToLocalStorage("counter", counter);
		window.location.href = "../BizApp-en/src/modules/profit/profit.html";
	});
	...
	$("#tax").on("click", function() {
		...
		saveDataToLocalStorage("infoData", Info);
		saveDataToLocalStorage("counter", counter);
		window.location.href = "../BizApp-en/src/modules/tax/tax.html";
	});
	...
	$("#salary").on("click", function() {
		...
		saveDataToLocalStorage("infoData", Info);
		saveDataToLocalStorage("counter", counter);
		window.location.href = "../BizApp-en/src/modules/salary/salary.html";
	});
});
